...
#def oldElementCleaner(listToBeCleaned):
#    import re
#    for i in range(len(listToBeCleaned)):
#        listToBeCleaned[i] = re.sub(r'\W+', '', listToBeCleaned[i])
#    while '' in listToBeCleaned:
#        listToBeCleaned.remove('')
